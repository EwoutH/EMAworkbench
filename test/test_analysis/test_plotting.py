...
class TestPlotting(unittest.TestCase):
    ...
    def test_envelopes(self):
        ...
        envelopes(experiments, outcomes, group_by="policy", density=Density.VIOLIN)
        envelopes(experiments, outcomes, group_by="policy", density=Density.BOXPLOT)
        envelopes(
            experiments,
            outcomes,
            group_by="policy",
        ...
        envelopes(experiments, outcomes, group_by="policy", density=Density.KDE)
        envelopes(experiments, outcomes, group_by="policy", density=Density.BOXENPLOT)
